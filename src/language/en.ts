export default {
  ...
  "chat.arbeidsgiver.metatittel":
    "Chat with us - Employers, public and private partners",
  ...
  "chat.sosialhjelp.metatittel":
    "Chat with us - Social services and financial assistance",
  "chat.okonomi.tittel": "Financial advice and debt counselling",
  "chat.okonomi.metatittel":
    "Chat with us - Financial advice and debt counselling",
  "chat.eures.tittel": "Ask EURES about jobs and recruitment in the EEA",
  "chat.eures.metatittel":
    "Chat with EURES about jobs and recruitment in the EEA",
  ...
  "felter.melding.beskrivelse": `Avoid sending sensitive personal information about your health condition or diagnoses. You can’t ask about the status of your application here. Login to <DittNavLenke>Ditt NAV</DittNavLenke> (text in Norwegian) and go to <SaksoversiktLenke>Dine saker</SaksoversiktLenke> for this information. If you don’t find the answer there you can check <BehandlingstiderLenke>case processing times</BehandlingstiderLenke> (text in Norwegian) or <SkrivTilOssLenke>write to us</SkrivTilOssLenke>.`,
  ...
  "felter.fullmakt.advarsel": `We cannot contact you unless we have received an authorisation from the person in question.<a href="{fullmaktskjema}" target="_blank">Go to the authorisation form</a>.`,
